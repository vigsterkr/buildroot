...
BB_INITRAMFS_TARGET_F:=$(notdir $(BB_INITRAMFS_TARGET))
...
$(BB_INITRAMFS_TARGET): host-fakeroot makedevs $(BR2_INITRAMFS_DIR)/bin/busybox
	...
	) > $(PROJECT_BUILD_DIR)/_fakeroot.$(BB_INITRAMFS_TARGET_F)
	chmod +x $(PROJECT_BUILD_DIR)/_fakeroot.$(BB_INITRAMFS_TARGET_F)
...
busybox-initramfs-menuconfig: host-sed $(BUILD_DIR) busybox-source $(BUSYBOX_INITRAMFS_DIR)/.configured
	$(MAKE) HOSTCC="$(HOSTCC) $(HOST_CFLAGS)" __TARGET_ARCH=$(ARCH) \
		-C $(BUSYBOX_INITRAMFS_DIR) menuconfig
