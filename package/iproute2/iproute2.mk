...
#
#############################################################
IPROUTE2_VERSION:=2.6.24
IPROUTE2_STAMP:=-rc7
IPROUTE2_SOURCE:=iproute2-$(IPROUTE2_VERSION)$(IPROUTE2_STAMP).tar.bz2
IPROUTE2_SITE:=http://devresources.linux-foundation.org/dev/iproute2/download/
