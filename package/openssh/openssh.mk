...
OPENSSH_SITE=http://openssh.linux-mirror.org/portable
...
$(OPENSSH_DIR)/ssh: $(OPENSSH_DIR)/.configured
	$(MAKE) -C $(OPENSSH_DIR)
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/scp
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/sftp
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/sftp-server
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh-add
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh-agent
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh-keygen
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh-keyscan
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh-keysign
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/ssh-rand-helper
	-$(STRIPCMD) $(STRIP_STRIP_ALL) $(OPENSSH_DIR)/sshd
